...
function AdminLogin() {
  ...
  return (
    ...
    <h1 className="flex flex-col justify-center font-semibold">Welcome back Admin</h1>
   ...
   />
    ...
    {checked ? <Register setChecked={setChecked} /> : <Login/>}
    </div>
